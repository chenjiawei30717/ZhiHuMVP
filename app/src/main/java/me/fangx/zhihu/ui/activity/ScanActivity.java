 ...
 */
public class ScanActivity extends BaseSwipeBackCompatActivity {
    ...
    protected void initViewsAndEvents() {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.scan_content_layout, fragment).commit();
    }
